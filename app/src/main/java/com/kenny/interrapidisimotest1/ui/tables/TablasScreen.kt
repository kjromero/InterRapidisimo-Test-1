package com.kenny.interrapidisimotest1.ui.tables
    ...
    Scaffold(
        ...
        Box(
            ...
            when (val state = uiState) {
                is TablesUiState.Loading -> LoadingOverlay()
                is TablesUiState.Success -> TableList(state.tables)
                is TablesUiState.Error -> ErrorMessage(state.error.toUiMessage())
            }
        }
    }
}
